      ...
      {isOpen && (
        <>
          ...
          <motion.div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              <h3 className="text-[15px] font-black tracking-[-0.02em]" style={{ color: "#0f172a", fontFamily: "'Syne',sans-serif" }}>
                {title}
              </h3>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          >
            ...
            {/* Column headers */}
            <div
              className="grid grid-cols-5 items-center px-3 sm:px-5 py-3"
              style={{
              ...
              {loading ? (
                ...
                displayed.map((sub, index) => (
                  <motion.div
                    ...
                    className="grid grid-cols-5 items-center px-3 sm:px-5 py-3.5"
                    style={{
  ...
  return (
    <>
      <style>{`
        ...
        .sl-wrap, .sl-wrap * { box-sizing: border-box; font-family: 'DM Sans', sans-serif; }
        .sl-serif { font-family: 'Syne', sans-serif !important; }
      `}</style>
        ...
        <div className="w-full">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="text-center">
              <h1
                className="sl-serif text-[20px] sm:text-[24px] md:text-[28px] font-black tracking-[-0.03em]"
                style={{ color: "#1e293b" }}
              >
                {t("সাবলিংক", "Sublinks")}
              </h1>
